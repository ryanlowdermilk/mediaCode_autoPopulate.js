...
(function() {
    ...
    function translateMediaCategoryId() {
        ...
        var selectedMediaCategoryId = jQuery('#jform_category_id :selected').text();
    ...
    function translateMediaClassId() {
        ...
        var selectedMediaClassId = jQuery('#jform_class_id :selected').text();
    ...
    function updateMediaCode() {
        ...
        jQuery('#jform_media_code').val(updatedMediaCode);
    }
    ...
    jQuery('#jform_media_date').on('change', updateMediaCode);
    jQuery('#jform_media_time').on('change', updateMediaCode);
    jQuery('#jform_category_id').on('change', updateMediaCode);
    jQuery('#jform_class_id').on('change', updateMediaCode);
